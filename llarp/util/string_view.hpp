...
// Copied from worktips-mq (with namespaces modified); when we fully import worktips-mq
// we can just use it directly.

// To keep this identical to worktips-mq's copy (e.g. to be able to diff it):
//
// clang-format off
