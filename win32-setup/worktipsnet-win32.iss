...
AppMutex=worktipsnet_win32_daemon,worktipsnet_qt5_ui,worktipsnet_dotnet_ui
...
Source: "worktipsnet-qt5-ui.7z"; DestDir: "{app}"; Flags: ignoreversion deleteafterinstall; MinVersion: 0,6.0;
Source: "worktipsnet.ico"; DestDir: "{app}"; Flags: ignoreversion;
...
Source: "config_migration.bat"; DestDir: "{userappdata}\.worktipsnet"; Flags: deleteafterinstall; MinVersion: 0,6.0
...
Type: filesandordirs; Name: "{app}\worktipsnet-qt5-ui"; MinVersion: 0,6.0
...
begin
  ...
  if IsTaskSelected('migrateconfigs') then
    MsgBox('Worktipsnet JSON-RPC API endpoint enabled. Any custom configuration was retained in %APPDATA%\.worktipsnet\worktipsnet.old.ini.', mbInformation, MB_OK);
  end;
end;
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; OnlyBelowVersion: 0, 6.0; IconFilename: "{app}\worktipsnet.ico"
Name: "{group}\{#MyAppName}"; Filename: "{app}\worktipsnet-qt5-ui\worktipsnetui.exe"; MinVersion: 0, 6.0; IconFilename: "{app}\worktipsnet.ico"
Name: "{group}\{cm:ProgramOnTheWeb,{#MyAppName}}"; Filename: "{#MyAppURL}"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; OnlyBelowVersion: 0,6.0; IconFilename: "{app}\worktipsnet.ico"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\worktipsnet-qt5-ui\worktipsnetui.exe"; Tasks: desktopicon; MinVersion: 0,6.0; IconFilename: "{app}\worktipsnet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: quicklaunchicon; OnlyBelowVersion: 0, 6.1; IconFilename: "{app}\worktipsnet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\User Pinned\TaskBar\{#MyAppName}"; Filename: "{app}\worktipsnet-qt5-ui\worktipsnetui.exe"; Tasks: quicklaunchicon; MinVersion: 0, 6.1; IconFilename: "{app}\worktipsnet.ico"
...
Filename: "{app}\worktipsnet-qt5-ui\worktipsnetui.exe"; Flags: nowait postinstall skipifsilent; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; MinVersion: 0,6.0
...
Filename: "{tmp}\7z.exe"; Parameters: "x worktipsnet-qt5-ui.7z -aoa"; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated skipifdoesntexist; Description: "installing modern Qt5 UI"; StatusMsg: "Installing modern Qt5 UI..."; MinVersion: 0, 6.0;
...
Filename: "{userappdata}\.worktipsnet\config_migration.bat"; WorkingDir: "{userappdata}\.worktipsnet"; Flags: runascurrentuser waituntilterminated; Description: "migrate existing config"; StatusMsg: "Migrating old configuration..."; MinVersion: 0,6.0; Tasks: migrateconfigs;